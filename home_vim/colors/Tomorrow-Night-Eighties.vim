...
let s:brown = "FF4040"
let s:pink = "FFB5C5"
let s:dark_cyan = "008B8B"
let s:green_yellow = "ADFF2F"
let s:lime_green = "32CD32"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" C Highlighting
    " see the difinition in syntax/c.vim and syntax/cpp.vim - zdb
	call <SID>X("cType", s:yellow, "", "")
	call <SID>X("cStorageClass", s:cyan, "", "")
	call <SID>X("cConditional", s:cyan, "", "")
	call <SID>X("cRepeat", s:cyan, "", "")
    call <SID>X("Statement", s:green_yellow, "", "")
    call <SID>X("Structure", s:lime_green, "", "")
